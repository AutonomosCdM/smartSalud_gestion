...
export OPENAI_API_KEYS="${GOOGLE_API_KEY:?ERROR: Set GOOGLE_API_KEY in your environment}"
...
export RAG_OPENAI_API_KEY="${GOOGLE_API_KEY:?ERROR: Set GOOGLE_API_KEY in your environment}"
