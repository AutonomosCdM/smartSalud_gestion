...
**SmartDoc** es una plataforma de interfaz de chat avanzada y extensible, construida sobre **Open WebUI**. Su objetivo es proporcionar una experiencia de usuario premium ("Silent Luxury") e integración profunda con modelos LLM de vanguardia (Google Gemini).
...
*   **Punto de Entrada**: `run_local.sh` -> `backend/open_webui/main.py`.
